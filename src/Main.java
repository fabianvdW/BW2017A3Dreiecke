...
public class Main {
    ...
    public static boolean isValidesDreieck(Schnittpunkt s1, Schnittpunkt s2, Schnittpunkt s3){
        ...
        if(s2s3==null || s1s2Complete.equals(s1s3Complete)||s1s2Complete.equals(s2s3Complete)|| s1s3Complete.equals(s2s3Complete))return false;
    ...
    public static  ArrayList<Dreieck> berechneDreiecke(ArrayList<Schnittpunkt> schnittpunkte){
        ...
        A:for (int i = 0; i < schnittpunkte.size(); i++) {
            Schnittpunkt s1 =  schnittpunkte.get(i);
            B:for (int j = i+1; j < schnittpunkte.size(); j++) {
                if(j==i)continue B;
                Schnittpunkt s2= schnittpunkte.get(j);
                C:for (int k = j+1; k < schnittpunkte.size(); k++) {
